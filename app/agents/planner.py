...
def planner_decide(state: AgentState) -> Literal["normalize", "validate"]:
    """
    Devuelve:
    ...
    if mode == "llm" and get_llm is not None:
        ...
        sys = SystemMessage(content="Clasifica el INPUT: responde SOLO 'normalize' si es lenguaje natural o 'validate' si ya es pseudocódigo.")
