...
## Tarea
Analiza el uso de memoria y espacio del algoritmo considerando el **peor caso espacial (Big O)**.

Transforma el análisis espacial en una expresión compatible con **SymPy** para su resolución automática.

## Consideraciones
- Identifica el peor caso espacial basándote en el pseudocódigo y el AST
